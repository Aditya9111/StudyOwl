            ...
            <Box className="my-auto">
              <Box sx={styles.ctaThree.content}>
                <BlockTitle
                  ...
                  heading={
                    "Watch cartoons and informative videos \n anytime & anywhere"
                  }
                />
                <Text as="p">{"High quality content delivered seemlesly"}</Text>
                <Link path="#" label="Explore more" variant="buttons.primary" />
              </Box>
            </Box>
          </Box>
          <Box sx={styles.ctaThree.colOne}>
            <Grid sx={styles.ctaThree.grid}>
              ...
              <Box sx={styles.ctaThree.box}>
                ...
                <Text as="p">{"Daily updated videos "}</Text>
              </Box>
              <Box sx={styles.ctaThree.box}>
                <Heading sx={styles.ctaThree.color4} as="h3">
                  & 3M
                </Heading>
                <Text as="p">{"Hours played"}</Text>
              </Box>
            </Grid>
          </Box>
        </Flex>
